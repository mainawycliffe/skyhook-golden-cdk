 ...
 *
 * Note that we highly recommend having esbuild in your project dev dependencies
 * as cdk will then compile your function
...
export default class SkyhookNodejsFunction extends NodejsFunction {
  constructor(scope: Construct, id: string, props: NodejsFunctionProps) {
    // removing out bundling from other props to allow minify to be true unless
